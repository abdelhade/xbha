        ...
        @forelse($products as $product)
            <div class="relative">
                <a href="{{ route('products.show', $product->slug) }}"
                    class="block elegant-card rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 group">
                    <!-- Product Image -->
                    ...
                    <div class="p-4">
                        <h3
                            class="font-bold text-gray-900 mb-2 line-clamp-2 group-hover:text-purple-600 transition-colors">
                            {{ $product->title }}
                        </h3>
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-2">
                                <div
                                    ...
                                    <span
                                        class="text-xs font-bold text-white">{{ substr($product->user->name, 0, 1) }}</span>
                                </div>
