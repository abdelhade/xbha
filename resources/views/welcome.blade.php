        ...
        <div class="container mx-auto px-4 py-4">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-3">
                    @auth
                        <a href="/dashboard" class="px-4 py-2 text-purple-600 hover:text-purple-700 transition">
                            لوحة التحكم
                        </a>
                    @else
                        <a href="/admin/tenants" class="px-4 py-2 text-gray-700 hover:text-purple-600 transition">
                            إدارة المتاجر
                        </a>
                        <a href="/products" class="px-6 py-2 bg-gradient-to-r from-purple-600 to-indigo-600 text-white rounded-lg hover:from-purple-700 hover:to-indigo-700 transition shadow-md">
                            تصفح المتاجر
                        </a>
                    @endauth
                </div>
