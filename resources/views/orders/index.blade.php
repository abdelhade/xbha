...
<body class="gradient-bg min-h-screen" dir="rtl">
    ...
    <section class="py-12 relative z-10">
        <div class="container mx-auto px-4">
            <h2 class="text-4xl font-bold text-gray-900 mb-8 text-center">طلباتي</h2>
                    ...
                    @foreach($orders as $order)
                        <div class="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition">
                            ...
                            <div class="border-t pt-4">
                                ...
                                <p class="text-gray-700 mb-2"><strong>السعر:</strong> {{ number_format($order->total_price) }} ريال</p>
            ...
            @else
                <div class="max-w-md mx-auto text-center bg-white rounded-xl p-12 shadow-lg">
                    ...
                    <p class="text-gray-600 mb-6">لم تقم بأي طلبات حتى الآن</p>
