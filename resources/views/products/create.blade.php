...
<head>
    ...
    <title>إضافة إعلان جديد - مزادي</title>
...
<body style="font-family:'Noto Kufi Arabic',sans-serif;background:#0f1e23;color:#f0e8cc;min-height:100vh">
    ...
    <div style="max-width:900px;margin:0 auto;padding:2rem 1rem">
        <div style="margin-bottom:2rem">
            <h2 style="font-size:1.75rem;font-weight:900;color:#f0e8cc">إضافة إعلان جديد</h2>
            <p style="font-size:.875rem;color:rgba(240,232,204,.45);margin-top:.25rem">أضف تفاصيل منتجك لبدء البيع</p>
        </div>
